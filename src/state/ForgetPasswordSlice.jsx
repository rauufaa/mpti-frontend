...
export const forgetPasswordSendEmail = createAsyncThunk(
    ...
    async (data, thunkAPI) => {
        ...
        try {
            const response = await axios.post("http://localhost:3000/forget-password/email", prepData, {
                headers: {
...
export const forgetPasswordSendCode = createAsyncThunk(
    ...
    async (data, thunkAPI) => {
        ...
        try {
            const response = await axios.post("http://localhost:3000/forget-password/code", prepData, {
                headers: {
                    "Content-Type": "application/json"
                }
            })
...
export const forgetPasswordSendNewPass = createAsyncThunk(
    ...
    async (data, thunkAPI) => {
        ...
        try {
            const response = await axios.post("http://localhost:3000/forget-password/new-password", prepData, {
                headers: {
                    "Content-Type": "application/json"
                }
            })
