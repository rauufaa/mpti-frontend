...
function ForgetPasswordNewPass() {
  ...
  const handleNewPassSubmit = (event) => {
    ...
    console.log("yahahi", forgetPasswordState.data.newPass, forgetPasswordState.data.reNewPass)
  ...
  return (
    <Form onSubmit={handleNewPassSubmit} className="card-body items-center">
      <h2 className="text-[2em] font-bold text-center">UBAH KATA SANDI</h2>
      {
        forgetPasswordState.error && (
      ...
      <div className="card-actions justify-center w-full p-4">
        <button type="submit" className="btn rounded-full w-full max-w-80" disabled={forgetPasswordState.loading}>
